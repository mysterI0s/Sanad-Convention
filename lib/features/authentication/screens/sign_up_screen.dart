                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8.h),
                        Text(
                          AppStrings.createYourOwnAccountToGetStarted.tr(),
                              ...
                              listener: (context, state) {
                                if (state is RegisterSuccessState) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                          AppStrings.signedUpSuccessfully.tr()),
                                ...
                                return MainButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (phone.isEmpty ||
                                      ...
                                      context.read<AuthCubit>().register(phone,
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    AppStrings.login.tr(),
                                    style:
                                        AppTextStyle.f16W300RedColor.copyWith(
